...
function InitiateSideMenu() {
    ...
    var useCollaspe = false;
    if($(".page-sidebar .sidebar-menu").hasClass('useCollaspe')){
        useCollaspe = true;
    }  
    $(".page-sidebar .sidebar-menu > li > a").on("click", function(e) {
        e.preventDefault();
        if(useCollaspe === true){
            console.log("useCollaspe = true");
            if ($(this).parent().hasClass("open")) {
                $(this).next(".submenu").slideToggle(200);
                $(this).parent().toggleClass("open");
            } else {
                $(".page-sidebar .sidebar-menu > li > .submenu").slideUp(200);
                $(".page-sidebar .sidebar-menu > li").removeClass("open");
...
jQuery(document).ready(function () {
    ...
    if (jQuery(document).width() > 880) {
        if($(".page-sidebar .sidebar-menu").hasClass('useCollaspe')){
            $(".page-sidebar .sidebar-menu > li").removeClass('open');
            jQuery('.sidebar-menu li ul li.active').parents('ul.submenu').parent("li").addClass('open');
            jQuery('.tree-folder-name.isCreate.active').parents('ul.submenu').parent("li").addClass('open');
        }
        else{
            jQuery('.sidebar-menu li ul li.active').parents('ul.submenu').parent("li").addClass('open');
            jQuery('.tree-folder-name.isCreate.active').parents('ul.submenu').parent("li").addClass('open');
