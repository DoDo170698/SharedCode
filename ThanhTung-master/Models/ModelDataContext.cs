...
{
    public class ModelDataContext<T> where T : class, new()
    {
        public static Database Instance { get; set; }
        public static string ConnectString = "CloudConnectString";
        public static ModelDataContext<T> UseInstance
        {
            get
            {
                return new ModelDataContext<T>(ConnectString);
            }
        }
        public ModelDataContext(string connectString = "CloudConnectString")
        {
        ...
        public bool FieldExist(string field, object value, int id = 0, int idChannel = 0)
        {
            try
            {
                Instance = GetInStance();
