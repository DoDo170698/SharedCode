...
{
    public class AmountOrderController : BaseController
    {
        string defauthPath = "/AmountOrder?ViewName=Receive";
        [AuthorizeCustom(Modules = new int[] { (int)IModule.QLHD_Manage })]
        public ActionResult Index()
        {
            var searchParm = new SearchParam().BindData(DATA);
            searchParm.Type = (int)OrderType.Amount;
            Paging.PageSize = 5;
        ...
        public ActionResult Save()
        {
            ...
            order.Type = (int)OrderType.Amount;
        ...
        public ActionResult IsDelivery()
        {
            ...
            return GetDialogResultOrView(new ViewParam
            {
                ...
                Data = new OrderModel
                {
                    ...
                    Customer = customer,
                    Supplier = supplier,
                    Url = "/AmountOrder/DeliveryChange"
                }
            }); ;
        }
        ...
        public ActionResult IsCollectVouchers()
        {
            ...
            return GetDialogResultOrView(new ViewParam
            {
                Data = new OrderModel
                {
                    ...
                    Url = string.Format("/AmountOrder/CollectVouchers"),
                },
        ...
        public ActionResult CollectVouchers()
        {
            ...
            {
                SetError("Bạn chưa chọn chọn đủ 2 file");
                return GetResultOrReferrerDefault(defauthPath);
            }
            if (!paths.IsNullOrEmpty())
            {
